...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      "40% increase in driver earnings across the Chargeup network. 98% vehicle uptime — powered by Digital Twin predictive intelligence and AI Genie automation. < 2% Gross NPAs — enabled by Risk Engine intent scoring and Karma Score behavioural analytics. 50% reduction in OEM service costs through autonomous issue resolution.",
