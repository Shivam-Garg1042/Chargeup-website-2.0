  ...
  return (
    <section className="flex flex-col items-start justify-center p-2 lg:px-4">
      <Card className="w-full rounded-lg md:rounded-xl lg:rounded-2xl border-none overflow-hidden relative bg-cover bg-center bg-no-repeat"
            style={{
              backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('/sol_home.png')`
            }}>
          ...
          <div className="flex flex-col items-start gap-6 md:gap-8 w-full">
            ...
            <div className="flex items-start pt-2 md:pt-4 lg:px-[24px]">
              <Button 
                ...
                className="bg-[#07584D] px-4 py-2 text-[#ffffff] border border-[#fff] rounded-md md:rounded-lg text-base md:text-base lg:text-lg font-semibold font-['Plus_Jakarta_Sans',Helvetica] shadow-sm hover:bg-[#033F4F]/90"
              >
                Partner with us
              </Button>
