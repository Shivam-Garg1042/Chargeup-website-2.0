...
<div className="flex items-center justify-center sm:justify-start sm:self-center gap-2 bg-gradient-to-r sm:bg-gradient-to-b from-[#07584D] to-[#023350] text-white px-4 sm:px-3 py-4 sm:py-6 rounded-lg font-bold shadow-lg backdrop-blur-sm w-[80%] mx-auto sm:w-12 sm:h-[200px] sm:mx-0">
