...
>
  <path d="M0 0.333008H1920V10.3604C1920 339.166 849 10.3604 0 10.3604V0.333008Z" fill="white" />
      ...
      <Card className="border-none bg-transparent shadow-none w-full max-w-screen-xl px-4 md:px-10 mx-auto">
        ...
        <CardContent className="p-0">
          <div className="flex flex-col items-center justify-center gap-8 max-w-[1142px] mx-auto">
            ...
            <p className="max-w-[620px] font-['Plus_Jakarta_Sans',Helvetica] font-normal text-[#646464] text-[17px] md:text-[19px]  text-center leading-8 mb-12">
